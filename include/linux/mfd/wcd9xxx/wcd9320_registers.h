...
/*to make Z7MINI AMIC1 as single mic added by sunli 20131226*/
#define TAIKO_A_MICB_1_INT_RBIAS__POR				(0x00)
#else
...
#ifdef CONFIG_ZTEMT_AUDIO_Z7MINI
/*to disable external noise filter cap for Z7MINI added by sunli 20131226 */
#define TAIKO_A_MICB_CFILT_3_CTL__POR				(0x00)
#else
...
#ifdef CONFIG_ZTEMT_AUDIO_Z7MINI
/*to make Z7MINI AMIC3 as single mic added by sunli 20131226*/
#define TAIKO_A_MICB_3_INT_RBIAS__POR				(0x00)
#else
