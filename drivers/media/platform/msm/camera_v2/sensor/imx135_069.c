...
extern int msm_sensor_set_vreg_gpio_dt_data(int enable);
...
static struct msm_sensor_ctrl_t imx135_s_ctrl = {
	...
	.power_setting_array.set_rear_vreg_gpio = msm_sensor_set_vreg_gpio_dt_data,
	.power_setting_array.get_rear_dt_vreg_gpio = 1,
