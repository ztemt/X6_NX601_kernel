...
extern int msm_sensor_set_front_vreg_gpio(int enable);
...
static struct msm_sensor_ctrl_t ov5648_s_ctrl = {
	...
	.power_setting_array.set_front_vreg_gpio = msm_sensor_set_front_vreg_gpio,
	.power_setting_array.get_front_dt_vreg_gpio = 1,
