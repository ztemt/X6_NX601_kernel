...
/*avdd neg ctl add ,mayu 9.18*/
        ...
        //mayu modify for accelerate
				udelay(pdata->panel_info.rst_seq[i] * 1000);
...
#ifdef CONFIG_ZTEMT_MIPI_1080P_R63311_SHARP_IPS_6P4
//avdd and rst min interval 10ms on lcm spec
		mdelay(10);
#endif
...
#ifdef CONFIG_ZTEMT_MIPI_1080P_R63311_SHARP_IPS_6P4
/*avdd off, 50ms iovdd off on lcm spec*/
		mdelay(50);
#endif

#ifdef CONFIG_ZTEMT_MIPI_1080P_R63311_SHARP_IPS_5P5
		mdelay(100);
#endif
	}
}
							...
							u32 bl_level)
{
  ...
  if((bl_level >700) && (bl_level <1000))
    bl_level += zte_get_lcd_bl_off();

  if(bl_level > ZTE_DEFALUT_MAX_BLLEVEL)
    bl_level = ZTE_DEFALUT_MAX_BLLEVEL;
