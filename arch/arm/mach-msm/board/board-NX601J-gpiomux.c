...
#define NO_USE_ES325
#ifdef NO_USE_ES325
//Let the gpio pull down because es325 is delete
//Add by wuzehui
//
static struct gpiomux_setting msm_es325_gpio_sus= {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
    .dir = GPIOMUX_IN,
	.pull = GPIOMUX_PULL_DOWN,
...
static struct msm_gpiomux_config msm_es325_configs[] __initdata = {
    {
        .gpio      = 55,        /*  NXP VEN */
        .settings = {
            [GPIOMUX_SUSPENDED] = &msm_es325_gpio_sus,
        },
    },
    {
        .gpio      = 56,        /*  NXP GPIO4 */
...
//Add by wuzehui
#define Z7_SPEAKER_EXT_PA_GPIO
#ifdef Z7_SPEAKER_EXT_PA_GPIO
